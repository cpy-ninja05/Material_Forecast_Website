...
const Navigation = () => {
  ...
  return (
    <>
      ...
      <aside 
        ref={sidebarRef}
        className={`fixed left-0 top-0 h-screen bg-gradient-to-b from-gray-100 to-gray-200 dark:from-[#0b1220] dark:to-[#111827] flex flex-col border-r border-gray-300 dark:border-gray-800 shadow-sm dark:shadow-[0_0_0_1px_rgba(255,255,255,0.06)] transition-all duration-300 ease-in-out ${
      ...
      >
        ...
        <div
          ref={resizeRef}
          className="absolute right-0 top-0 h-full w-2 bg-transparent hover:bg-gray-300 dark:hover:bg-gray-600 cursor-col-resize transition-colors group"
